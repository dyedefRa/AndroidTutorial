...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WhatsApp.Helper.PhoneAuthCallbacks, WhatsApp", PhoneAuthCallbacks.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PhoneAuthCallbacks.class)
			mono.android.TypeManager.Activate ("WhatsApp.Helper.PhoneAuthCallbacks, WhatsApp", "", this, new java.lang.Object[] {  });
	}

	public PhoneAuthCallbacks (crc64ee1668752c35d02a.PhoneLoginActivity p0)
	{
		super ();
		if (getClass () == PhoneAuthCallbacks.class)
			mono.android.TypeManager.Activate ("WhatsApp.Helper.PhoneAuthCallbacks, WhatsApp", "WhatsApp.Activities.PhoneLoginActivity, WhatsApp", this, new java.lang.Object[] { p0 });
	}
