...
public class FirebaseValuEventListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WhatsApp.Helper.FirebaseValuEventListener, WhatsApp", FirebaseValuEventListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == FirebaseValuEventListener.class)
			mono.android.TypeManager.Activate ("WhatsApp.Helper.FirebaseValuEventListener, WhatsApp", "", this, new java.lang.Object[] {  });
	}
